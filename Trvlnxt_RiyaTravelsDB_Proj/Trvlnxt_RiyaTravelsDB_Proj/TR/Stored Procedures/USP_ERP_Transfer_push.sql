...
CREATE PROCEDURE [Tr].[USP_ERP_Transfer_push] --@Action = 'TransferCancellation'             
...
--trm.CountryCode 'BookingCountry',            
  al.BookingCountry 'BookingCountry',     
  trm.CountryCode,
CASE                                                                                                     
  WHEN al.BookingCountry= trm.CountryCode                                                                                                  
   THEN 'Car-Dom'                                                                                                    
  ELSE 'Car-INT'                                                                                                    
  END AS 'ProductType',            
...
,al.UserTypeId,trm.creationDate 'inserteddate',tsh.CreateDate 'PostingDate',    
--br.country 'BookingCountry',            
al.BookingCountry  'BookingCountry',            
CASE                                                                                                     
  WHEN al.BookingCountry= trm.CountryCode                                                                                                  
