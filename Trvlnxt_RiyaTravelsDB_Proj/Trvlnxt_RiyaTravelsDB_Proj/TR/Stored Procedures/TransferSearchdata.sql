               ...
               --   [TR].[TransferSearchdata]  100,'TNA0000088',33435           
                            
                            
CREATE PROCEDURE [TR].[TransferSearchdata]                                                                                                                                        
...
BEGIN                                 
 ...
 Isnull(PD.totalPax,0)  as PaxCount,                                                  
...
isnull(PD.PassportNumber,'NA') as 'PassportNumber',                                              
 ...
 ISnull(BM.OBTCNo,'NA')  as OBTCNumber ,                                                                    
...
END AS PaymentGathwayCharges,                            
   ...
   isnull(BA.TotalLuggage,'-') as 'TourLanguage',                                          
   isnull(BM.ROEValue,1) as  ROEValue,                               
  --ISNULL(BM.RefName,'NA') as agentRefName,                                          
  ISnull(PD.Email,'NA') as 'SalesMgr' ,                                
   'NA' as 'Consultant',                                
  (Isnull(BM.BookingCurrency,'NA') + ' '+  CONVERT(varchar(200),BM.BookingRate)) as BookingAmount ,                                      
