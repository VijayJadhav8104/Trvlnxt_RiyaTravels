...
-- =============================================            
-- Author:Amol cahudhari    
-- Create date: 04-feb-2025           
...
-- =============================================            
CREATE PROCEDURE [TR].[TR_GetSSBookingSupplier_procedure]            
...
BEGIN            
 ...
 --Declare  @ProviderConfirmationNumber  nvarchar(100)  
 ...
 -- set @ProviderConfirmationNumber=(select top 1 ProviderConfirmationNumber from TR.TR_BookingMaster where ltrim(rtrim(BookingRefId))=ltrim(rtrim(@bookingid)))   
 ...
 --      ,@correlationId as correlationId , @AccountId as 'AccountId', @ChannelId as 'ChannelId',@ProviderConfirmationNumber AS 'ProviderConfirmationNumber'              
