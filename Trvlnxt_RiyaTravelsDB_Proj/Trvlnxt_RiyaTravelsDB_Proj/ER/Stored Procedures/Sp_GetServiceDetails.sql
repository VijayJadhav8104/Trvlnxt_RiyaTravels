...
CREATE proc [ER].Sp_GetServiceDetails        
@UserType varchar(50)=null,        
@MarketPoint varchar(50)=null        
AS        
BEGIN         
 select         
 CD.Id,TravelValidityFrom,TravelValidityTo,SaleValidityTo,SaleValidityFrom,Origin,Destination,MarketPoint,GST,      
 BookingType,Cabin,Deck,Room,Currency,ServiceType,CD.isActive,CreatedDate,ModifiedDate,MU.UserName as 'CreatedBy',      
 case      
...
GRANT VIEW DEFINITION
    ON OBJECT::[ER].[Sp_GetServiceDetails] TO [rt_read]
    AS [RiyaTravels];
