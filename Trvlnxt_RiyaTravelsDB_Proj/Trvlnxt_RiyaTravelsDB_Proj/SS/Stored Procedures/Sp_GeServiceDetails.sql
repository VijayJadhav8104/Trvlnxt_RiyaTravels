...
create proc [SS].Sp_GeServiceDetails        
@UserType varchar(50)=null,        
@MarketPoint varchar(50)=null        
AS        
BEGIN         
 select         
 CD.Id,TravelValidityFrom,TravelValidityTo,SaleValidityTo,SaleValidityFrom,MarketPoint,GST,      
 BookingType,Currency,ServiceType,CD.isActive,CreatedDate,ModifiedDate,ReservationType,TimeSlotFrom,TimeSlotTo,MU.UserName as 'CreatedBy',      
 case      
...
GRANT VIEW DEFINITION
    ON OBJECT::[SS].[Sp_GeServiceDetails] TO [rt_read]
    AS [DB_TEST];
