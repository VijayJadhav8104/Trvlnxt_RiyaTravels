...
CREATE proc [Insurance].[Sp_GetInsuranceFlatDetails]        
@UserType varchar(50)=null,        
@MarketPoint varchar(50)=null        
AS        
BEGIN         
  select                 
 CD.Id,TravelValidityFrom,TravelValidityTo,SaleValidityTo,SaleValidityFrom,MarketPoint,GST,AgentId,              
 Currency,ServiceType,CD.isActive,CreatedDate,ModifiedDate,MU.UserName as 'CreatedBy',              
 case              
 ...
 from insurance.tbl_Insurance_Discount  CD              
