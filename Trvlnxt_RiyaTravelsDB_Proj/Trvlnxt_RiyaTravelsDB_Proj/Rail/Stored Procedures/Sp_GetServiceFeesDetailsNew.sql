...
CREATE proc [Rail].[Sp_GetServiceFeesDetailsNew]  --2,'Select',''                   
@UserType int=0,                    
...
begin            
 ...
 IssuanceFrom,IssuanceTo,MarketPoint,FixedServiceFeesAmt,GSTServiceFees, AgencyName,              
ServiceType,CD.isActive,CreatedDate,ModifiedDate,MU.UserName as 'CreatedBy',MU.FullName,                
 ...
 from [Rail].[tbl_ServiceFeeNew]  CD                  
 left join mUser MU on Mu.ID=CD.CreatedBy                  
 where              
 (CD.AgencyName=@AgencyName or CD.AgencyName='All')and            
   CD.isActive=1            
