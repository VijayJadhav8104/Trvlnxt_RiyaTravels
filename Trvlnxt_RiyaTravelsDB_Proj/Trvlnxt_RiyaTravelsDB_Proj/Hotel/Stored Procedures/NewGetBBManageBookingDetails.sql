...
-- execute [hotel].[NewGetBBManageBookingDetails] '0','1261','','','','','','','0','','','','','','','','0','','Hotels'                                                                        
-- =============================================                                                                            
CREATE PROCEDURE [Hotel].[NewGetBBManageBookingDetails]            
...
Begin           
 ...
 from Hotel_BookMaster HB                                                                            
  ...
  where             
   ...
   and HH.IsActive=1             
   --and AL.BalanceFetch='Console'         
   --and AL.userTypeID=2         
   --and  AL.Country='INDIA'        
     
   --Enhancement #2554 --Activate Hotel-Track Deck & Flight - BOOKING TRACK for Saudi Arabia to track agent transactions.  
    AND (  
