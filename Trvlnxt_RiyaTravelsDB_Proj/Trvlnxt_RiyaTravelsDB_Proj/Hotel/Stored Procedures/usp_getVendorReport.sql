...
--exec Hotel.usp_getVendorReport '22-Apr-2025','22-Apr-2025','0'            
     -- orginal sp not have transfer data [Hotel].[usp_getVendorReport]  
        
CREATE  proc [Hotel].[usp_getVendorReport]                                        
...
SELECT            
    ...
    'NA' AS Selling_Market,                      
     0 AS Total_Booking_Foriegn_Currency,                      
    Isnull(SUM(COALESCE(HB.SupplierRate * HB.SupplierToInrRoe, HB.AmountBeforePgCommission)),0) AS Total_Booking_Amount,                      
    COUNT(HB.BookingId) AS Booking_Count,                      
    100 AS Percentage_Share,                      
    '-' AS Vendor_Status,                      
    100 AS BookingPercentage            
...
SELECT            
    ...
    'NA' AS Selling_Market,                      
     0 AS Total_Booking_Foriegn_Currency,                      
    ISnull(SUM(COALESCE(HB.SupplierRate * HB.SupplierINRROEValue, HB.DisplayDiscountRate)),0) AS Total_Booking_Amount,                      
    COUNT(HB.pkId) AS Booking_Count,                      
    100 AS Percentage_Share,                      
    '-' AS Vendor_Status,                      
    100 AS BookingPercentage            
...
SELECT            
    ...
    'NA' AS Selling_Market,                      
     0 AS Total_Booking_Foriegn_Currency,                      
   Isnull( SUM(COALESCE(HB.SupplierRate * HB.Roevalue, HB.BookingRate)),0) AS Total_Booking_Amount,                      
    COUNT(HB.BookingId) AS Booking_Count,                      
    100 AS Percentage_Share,                      
    '-' AS Vendor_Status,                      
    100 AS BookingPercentage            
...
'NA' AS Selling_Market,        
0 AS Total_Booking_Foriegn_Currency,        
Isnull(SUM(Total_Booking_Amount),0) AS Total_Booking_Amount,        
Isnull(SUM(Booking_Count),0) AS Booking_Count,        
100 AS Percentage_Share,                         
'-' AS Vendor_Status,                         
100 AS BookingPercentage,             
10002 AS orderby        
