...
--CREATED BY Prakash Suryawanshi(03 Apr 2025)
--Modified BY Prakash Suryawanshi(03 Apr 2025)
--EXEC [Hotel].[Proc_rptChainSelectedNightsVendorWiseReport] '01-Apr-2025', '03-Apr-2025'
--select distinct * from B2BHotelSupplierMaster

CREATE PROCEDURE [Hotel].[Proc_rptChainSelectedNightsVendorWiseReport]
...
';
    ...
    SET @sql = @sql + N' GROUP BY HB.totalRooms, SelectedNights, SM.SupplierName, HB.cityName, HB.ChainName, HB.HotelName, HotelBookCountryName,countryname, convert(date, HB.inserteddate)';
