         -- [Hotel].[RecoDetails_1] @BookingId='TNH00255166',@SearchBy='3'                            
   -- [Hotel].[RecoDetails]  @SearchBy='1',    @StartDate='27-May-2024',@EndDate='27-May-2024'                      
                        
CREATE PROC [Hotel].[RecoDetails_1]                                                                                                    
 ...
 --END                                                          
   ...
   ,ISNULL(                    
        STUFF((                    
           ...
           WHERE HH.fkbookid= HB.pkId and HH.FieldName in ('Pax Modified','ServiceTime_Modified','ModifiedBooking','ModifiedRoE')                 
            FOR XML PATH('')                    
        ), 1, 2, ''), 'NA')    as Remarks          
