...
--EXEC [Hotel].[Proc_rptChainAmountVendorWiseReport] '01-Apr-2025', '01-Apr-2025'
--select distinct * from B2BHotelSupplierMaster

CREATE PROCEDURE [Hotel].[Proc_rptChainAmountVendorWiseReport]
...
BEGIN
  ...
  SET @sql = N'SELECT 				
    ...
    SET @sql = @sql + N' GROUP BY SM.SupplierName, HB.cityName, HB.ChainName, HB.HotelName, HotelBookCountryName,countryname, convert(date, HB.inserteddate)';
