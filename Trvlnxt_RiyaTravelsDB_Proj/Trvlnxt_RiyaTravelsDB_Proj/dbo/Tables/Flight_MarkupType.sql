CREATE TABLE [dbo].[Flight_MarkupType] (
    ...
    [UserID]             INT             NULL,
    [UpdatedDate]        DATETIME        CONSTRAINT [DF_Flight_MarkupType_UpdatedDate] DEFAULT (getdate()) NULL,
    [RBD]                BIT             NULL,
    ...
    CONSTRAINT [PK_MstDiscount_Markup] PRIMARY KEY CLUSTERED ([ID] ASC)
);
