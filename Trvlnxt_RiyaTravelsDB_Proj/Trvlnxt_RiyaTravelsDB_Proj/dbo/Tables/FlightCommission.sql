CREATE TABLE [dbo].[FlightCommission] (
    ...
    [RBD]                BIT             CONSTRAINT [DF_FlightCommission_RBD] DEFAULT ((0)) NULL,
    [RBDValue]           VARCHAR (MAX)   NULL,
    [FareBasis]          BIT             CONSTRAINT [DF_FlightCommission_FareBasis] DEFAULT ((0)) NULL,
    [FareBasisValue]     VARCHAR (MAX)   NULL,
    [FlightSeries]       BIT             CONSTRAINT [DF_FlightCommission_FlightSeries] DEFAULT ((0)) NULL,
    [FlightSeriesValue]  VARCHAR (MAX)   NULL,
    [Origin]             BIT             CONSTRAINT [DF_FlightCommission_Origin] DEFAULT ((0)) NULL,
    [OriginValue]        VARCHAR (MAX)   NULL,
    [Destination]        BIT             CONSTRAINT [DF_FlightCommission_Destination] DEFAULT ((0)) NULL,
    [DestinationValue]   VARCHAR (MAX)   NULL,
    [InsertedDate]       DATETIME        NULL,
    [Flag]               BIT             CONSTRAINT [DF_FlightCommission_Flag] DEFAULT ((1)) NULL,
    [FlightNo]           BIT             CONSTRAINT [DF_FlightCommission_FlightNo] DEFAULT ((0)) NULL,
    ...
    [UserID]             INT             NULL,
    [UpdatedDate]        DATETIME        CONSTRAINT [DF_FlightCommission_UpdatedDate] DEFAULT (getdate()) NULL,
    ...
    [AdditionalAmount]   DECIMAL (18, 2) CONSTRAINT [DF_FlightCommission_AdditionalAmount] DEFAULT ((0.00)) NULL,
    [GDSCommission]      DECIMAL (18, 2) NULL,
    [AdditionalAmtType]  VARCHAR (20)    NULL,
    ...
    [AutoTicketing]      BIT             CONSTRAINT [DF_FlightCommission_AutoTicketing] DEFAULT ((0)) NULL,
    [Queueno]            VARCHAR (500)   NULL,
    [EmailId]            VARCHAR (MAX)   NULL,
    [TicketingAccess]    BIT             CONSTRAINT [DF_FlightCommission_TicketingAccess] DEFAULT ((0)) NULL,
    [OTP]                VARCHAR (20)    NULL,
    [UpdatedBy]          INT             NULL,
    ...
    CONSTRAINT [PK_FlightCommission] PRIMARY KEY CLUSTERED ([Id] ASC)
);
