CREATE TABLE [dbo].[mAttrributesDetails] (
    ...
    CONSTRAINT [PK_mAttrributesDetails_27_9_2024] PRIMARY KEY CLUSTERED ([ID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [mAttrributesDetails_GDSPNR]
    ON [dbo].[mAttrributesDetails]([GDSPNR] ASC);


GO
CREATE NONCLUSTERED INDEX [NONCLUSTERED_OrderID]
    ON [dbo].[mAttrributesDetails]([OrderID] ASC);


GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-fkPassengerid]
    ON [dbo].[mAttrributesDetails]([fkPassengerid] ASC);
