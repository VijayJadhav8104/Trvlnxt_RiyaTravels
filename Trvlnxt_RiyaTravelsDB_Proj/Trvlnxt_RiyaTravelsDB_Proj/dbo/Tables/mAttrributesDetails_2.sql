CREATE TABLE [dbo].[mAttrributesDetails_2] (
    ...
    [WinYatraPush]                        BIT           CONSTRAINT [DF_mAttrributesDetails_WinYatraPush] DEFAULT ((0)) NULL,
    ...
    CONSTRAINT [PK_mAttrributesDetails] PRIMARY KEY CLUSTERED ([ID] ASC)
);


GO
CREATE NONCLUSTERED INDEX [mAttrributesDetails_GDSPNR]
    ON [dbo].[mAttrributesDetails_2]([GDSPNR] ASC);


GO
CREATE NONCLUSTERED INDEX [NonClusteredIndex-fkPassengerid]
    ON [dbo].[mAttrributesDetails_2]([fkPassengerid] ASC);


GO
CREATE NONCLUSTERED INDEX [NONCLUSTERED_OrderID]
    ON [dbo].[mAttrributesDetails_2]([OrderID] ASC);
