...
CREATE PROCEDURE [dbo].[Transfer_PendingCancellation] --426,2,147                                                                    
...
from TR.TR_BookingMaster HB                                                             
 ...
 and SH.IsActive=1        
  ...
  select @Id,'Canx reconcilled','Pendingcancelconsole',GETDATE(),'Pending Cancellation Request',@ModifiedBy from TR.TR_BookingMaster where  BookingId= @Id            
...
--delete tr.TR_bookingUpdate_History where HistoryID in (2,3)