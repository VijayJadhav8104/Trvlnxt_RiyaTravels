--sp_helptext USP_ERP_Hotel_Activity_SS --USP_ERP_Hotel_Activity_SSLocal    
    
--sp_helptext USP_ERP_Hotel_Activity_SSLocal 'SightSeeingBooking'            
...
CREATE PROCEDURE [dbo].USP_ERP_Hotel_Activity_SSLocal                                                                                             
...
WHERE HSHVouchred.FkStatusId = 4                                                                                            
 ...
 AND Cast(HSHVouchred.CreateDate as date) >=cast('2025-03-10' as date)                        
 ...
 -- )                                                                                            
  ...
  and BookingRefId in ('TNA0001981')--('TNA0001758','TNA0001718')        
