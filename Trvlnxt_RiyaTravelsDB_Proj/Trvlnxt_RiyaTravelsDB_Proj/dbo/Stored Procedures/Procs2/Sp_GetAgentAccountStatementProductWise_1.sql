      ...
      --select CONVERT(VARCHAR, getdate(), 101),convert(varchar,getdate(),103),convert(varchar,getdate(),120)                            
--sp_helptext Sp_GetAgentAccountStatementProductWise_1 '2024-10-01','2024-10-21','','','2','50489','SA','Air','E86V2T'        
        
CREATE PROCEDURE [dbo].[Sp_GetAgentAccountStatementProductWise_1]                                                    
 @FROMDate Date=NULL                                                     
 , @ToDate Date=NULL                                                    
...
BEGIN                                                    
 ...
 IF OBJECT_ID ( 'tempdb..#tempTableAASRail') IS NOT NULL                                                          
  DROP table #tempTableAASRail                    
    ...
    IF OBJECT_ID ( 'tempdb..#tempTableAASTransfer') IS NOT NULL                                                  
  DROP table #tempTableAASTransfer             
...
SELECT * INTO #tempTableAASAir FROM (                                                    
  ...
  ,  CASE     
    WHEN B.BookingStatus = 6 AND coun.CountryCode = 'AE' THEN     
        UPPER(FORMAT(DATEADD(SECOND, -1*60*60 -29*60 -13, CONVERT(DATETIME, b.BookingTrackModifiedOn)), 'dd-MMM-yyyy HH:mm:ss'))    
    WHEN B.BookingStatus = 6 AND coun.CountryCode = 'SA' THEN     
        UPPER(FORMAT(DATEADD(SECOND, -1*60*60 -29*60 -13, CONVERT(DATETIME, b.BookingTrackModifiedOn)), 'dd-MMM-yyyy HH:mm:ss'))    
    WHEN B.BookingStatus = 6 AND coun.CountryCode = 'US' THEN     
        UPPER(FORMAT(DATEADD(SECOND, -9*60*60 -29*60 -16, CONVERT(DATETIME, b.BookingTrackModifiedOn)), 'dd-MMM-yyyy HH:mm:ss'))    
    WHEN B.BookingStatus = 6 AND coun.CountryCode = 'CA' THEN     
        UPPER(FORMAT(DATEADD(SECOND, -9*60*60 -29*60 -16, CONVERT(DATETIME, b.BookingTrackModifiedOn)), 'dd-MMM-yyyy HH:mm:ss'))    
    WHEN B.BookingStatus = 6 AND coun.CountryCode = 'IN' THEN     
        UPPER(FORMAT(CONVERT(DATETIME, b.BookingTrackModifiedOn), 'dd-MMM-yyyy HH:mm:ss'))    
    
    WHEN B.BookingStatus != 6 AND coun.CountryCode = 'AE' THEN     
        UPPER(FORMAT(DATEADD(SECOND, -1*60*60 -29*60 -13, CONVERT(DATETIME, ISNULL(b.IssueDate, ISNULL(b.inserteddate_old, b.inserteddate)))), 'dd-MMM-yyyy HH:mm:ss'))    
    WHEN B.BookingStatus != 6 AND coun.CountryCode = 'SA' THEN     
        UPPER(FORMAT(DATEADD(SECOND, -1*60*60 -29*60 -13, CONVERT(DATETIME, ISNULL(b.IssueDate, ISNULL(b.inserteddate_old, b.inserteddate)))), 'dd-MMM-yyyy HH:mm:ss'))    
    WHEN B.BookingStatus != 6 AND coun.CountryCode = 'US' THEN     
        UPPER(FORMAT(DATEADD(SECOND, -9*60*60 -29*60 -16, CONVERT(DATETIME, ISNULL(b.IssueDate, ISNULL(b.inserteddate_old, b.inserteddate)))), 'dd-MMM-yyyy HH:mm:ss'))    
    WHEN B.BookingStatus != 6 AND coun.CountryCode = 'CA' THEN     
        UPPER(FORMAT(DATEADD(SECOND, -9*60*60 -29*60 -16, CONVERT(DATETIME, ISNULL(b.IssueDate, ISNULL(b.inserteddate_old, b.inserteddate)))), 'dd-MMM-yyyy HH:mm:ss'))    
    WHEN B.BookingStatus != 6 AND coun.CountryCode = 'IN' THEN     
        UPPER(FORMAT(CONVERT(DATETIME, ISNULL(b.IssueDate, ISNULL(b.inserteddate_old, b.inserteddate))), 'dd-MMM-yyyy HH:mm:ss'))    
END AS 'DateTime',    
...
, CASE     
    WHEN coun.CountryCode = 'AE' THEN     
        UPPER(FORMAT(DATEADD(SECOND, -1*60*60 -29*60 -13, CONVERT(DATETIME, ab.createdon)), 'dd-MMM-yyyy HH:mm:ss'))  -- 1 hour, 29 minutes, and 13 seconds      
    WHEN coun.CountryCode = 'SA' THEN     
        UPPER(FORMAT(DATEADD(SECOND, -1*60*60 -29*60 -13, CONVERT(DATETIME, ab.createdon)), 'dd-MMM-yyyy HH:mm:ss'))  -- 1 hour, 29 minutes, and 13 seconds      
    WHEN coun.CountryCode = 'US' THEN     
        UPPER(FORMAT(DATEADD(SECOND, -9*60*60 -29*60 -16, CONVERT(DATETIME, ab.createdon)), 'dd-MMM-yyyy HH:mm:ss'))  -- 9 hours, 29 minutes, and 16 seconds      
    WHEN coun.CountryCode = 'CA' THEN     
        UPPER(FORMAT(DATEADD(SECOND, -9*60*60 -29*60 -16, CONVERT(DATETIME, ab.createdon)), 'dd-MMM-yyyy HH:mm:ss'))  -- 9 hours, 29 minutes, and 16 seconds      
    WHEN coun.CountryCode = 'IN' THEN     
        UPPER(FORMAT(CONVERT(DATETIME, ab.createdon), 'dd-MMM-yyyy HH:mm:ss'))  -- No adjustment for India      
END AS 'DateTime'    
...
   AND ((@ToDate = '') or (CONVERT(date,AB.CreatedOn) <= CONVERT(date, @ToDate)))                                 AND ((@BranchCode = '') or ( R.LocationCode = @BranchCode))                                                    
...
, CASE     
    WHEN coun.CountryCode = 'AE' THEN     
        UPPER(FORMAT(    
            DATEADD(SECOND, -1*60*60 -29*60 -13,     
                CONVERT(DATETIME, ISNULL(ab.createdon,     
                    CASE WHEN B.BookingStatus = 6 THEN b.BookingTrackModifiedOn ELSE ISNULL(ab.CreatedOn, b.inserteddate) END)    
                )    
            ),     
    ...
    WHEN coun.CountryCode = 'US' THEN     
        UPPER(FORMAT(    
            DATEADD(SECOND, -9*60*60 -29*60 -16,     
                CONVERT(DATETIME, ISNULL(ab.createdon,     
                    CASE WHEN B.BookingStatus = 6 THEN b.BookingTrackModifiedOn ELSE ISNULL(ab.CreatedOn, b.inserteddate) END)    
                )    
            ),     
    ...
    WHEN coun.CountryCode = 'AE' THEN     
        UPPER(FORMAT(    
            DATEADD(SECOND, -1*60*60 -29*60 -13,     
                CONVERT(DATETIME, ISNULL(ab.createdon,     
                    CASE     
                        WHEN B.BookingStatus = 6 THEN b.BookingTrackModifiedOn     
                        ELSE ISNULL(b.IssueDate, ISNULL(b.inserteddate_old, b.inserteddate))     
                    END)    
                )    
            ),     
        'dd-MMM-yyyy HH:mm:ss'))    
        ...
        UPPER(FORMAT(    
            DATEADD(SECOND, -1*60*60 -29*60 -13,     
                CONVERT(DATETIME, ISNULL(ab.createdon,     
                    CASE     
                        WHEN B.BookingStatus = 6 THEN b.BookingTrackModifiedOn     
                        ELSE ISNULL(b.inserteddate_old, b.inserteddate)     
                    END)    
                )    
            ),     
        'dd-MMM-yyyy HH:mm:ss'))    
...
--        UPPER(FORMAT(    
--            DATEADD(SECOND, -1*60*60 -29*60 -13,     
--                CONVERT(DATETIME, ab.createdon)    
--            ),     
--        'dd-MMM-yyyy HH:mm:ss'))  -- 1 hour, 29 minutes and 13 seconds    
...
--                CONVERT(DATETIME, ab.createdon)    
--            ),     
--        'dd-MMM-yyyy HH:mm:ss'))  -- 9 hours, 29 minutes and 16 seconds    
...
--        UPPER(FORMAT(    
--            CONVERT(DATETIME, ab.createdon),     
--        'dd-MMM-yyyy HH:mm:ss'))  -- No offset for India    
--END AS 'DateTime'    
        ...
        UPPER(FORMAT(    
            DATEADD(SECOND, -1*60*60 -29*60 -13,    
                CONVERT(DATETIME, ISNULL(ab.createdon,     
                    CASE     
                        WHEN B.BookingStatus = 6 THEN b.BookingTrackModifiedOn     
                        ELSE ISNULL(ab.CreatedOn, b.inserteddate)     
                    END)    
                )    
            ),     
        'dd-MMM-yyyy HH:mm:ss'))    
...
   AND ((@PaymentType='') OR (@PaymentType='all') OR ( PM.payment_mode = @PaymentType ))                                                    
  ...
  , ISNULL(r.AgencyName,r1.AgencyName) AS AgencyName                                                    
, CASE     
    WHEN coun.CountryCode = 'AE' THEN           UPPER(FORMAT(    
            DATEADD(SECOND, -1*60*60 -29*60 -13,    
                CONVERT(DATETIME, ISNULL(ab.createdon,     
                    CASE     
                        WHEN B.BookingStatus = 6 THEN b.BookingTrackModifiedOn     
...
, (B.HotelName + ' ' + B.HotelAddress1) AS 'Description'                                                  
  ...
  ,case when TL.BookingStatus='Confirmed' then 'Vouchered'else  TL.BookingStatus end AS 'Booking Status'                                                 
...
--  AND RiyaAgentID IS NOT NULL                            --  AND B.BookingReference is not NULL                                                     
...
AND sh.isactive = 1    LEFT JOIN mcountry coun WITH(nolock) ON coun.countrycode = b.countrycode                      
 ...
 union                          
   ...
   , cast( BR.Icast as varchar) as 'AgencyID'                                              
   , BR.AgencyName AS 'AgencyName'                                                
   ,convert(varchar,sh.CreateDate,120)  AS 'DateTime'                                               , CONCAT( isnull(act.activityname,' '),' - ',    isnull(act.activityoptionname,' ')) AS 'Description'                                             
   , b.BookingRefId AS 'Booking id'                                              
   , '' AS 'Riya / CRSPNR'                                              
   , '' AS AirlinePNR                                          
   , '0' 'CreditAmount'                                              
...
SELECT * INTO #tempTableAASRail FROM(                      
  ...
  , BR.AgencyName AS 'AgencyName'                                                
   ...
   ,case when bki.Type='Ticket' then bki.Origin +'--'+bki.Destination                  
 else bki.Type                  
  END AS 'Description'                                              
   , B.RiyaPnr AS 'Booking id'                                              
   , B.BookingReference AS 'Riya / CRSPNR'                                              
   , '' AS AirlinePNR                                          
...
AS 'Travel date'                      
  ...
  ,case when B.bookingStatus='INVOICED' then 'Confirmed'else ISNULL(b.bookingStatus,'NA') end AS 'Booking Status'                                             
   ...
   , b.BookingReference AS 'Supplier confirmation'                                              
...
AND (B.AgentId = @AgentId OR @AgentId = 0)    
AND B.BookingReference IS NOT NULL                                                 
...
SELECT * INTO #tempTableAASTransfer FROM(                                 
   -----Credit Limit--------                             
  SELECT                                
   CAST(B.BookingId AS VARCHAR(50)) AS BookMasterID                                                
   , BR.Icast as 'AgencyID'                                                
   , BR.AgencyName AS 'AgencyName'            
   ,TAB.CreatedOn  AS 'DateTime'                                              
 ,(B.PickupLocation+'===>'+B.DropOffLocation) AS 'Description'                                                
   , B.BookingRefId AS 'Booking id'                                                
   , BR.Icast AS 'Riya / CRSPNR'                 
   , '' AS AirlinePNR                                            
   ,  CASE WHEN tAB.TransactionType = 'Credit' and (B.BookingStatus='Cancelled' or B.BookingStatus IS NULL) THEN convert(VARCHAR(50), ISNULL(TAB.TranscationAmount, '0'))                                                      
   ELSE '0' END AS 'CreditAmount'                                        
  , CASE WHEN TAB.TransactionType = 'Debit' and (B.BookingStatus='Vouchered' or B.BookingStatus IS NULL) THEN convert(VARCHAR(50), ISNULL(TAB.TranscationAmount, '0'))                        
   WHEN TAB.TransactionType = 'Debit' and B.BookingStatus='Confirmed' THEN convert(VARCHAR(50), ISNULL(TAB.TranscationAmount, '0'))                                     
   ELSE '0' END AS 'DebitAmount'                                    
                                   
  , TAB.CloseBalance AS 'Remaining'                                                
   , 'Transfer' AS 'Service Type'                                                
   , B.CancellationRemark  as 'Remark'                                                
   ...
   , b.BookingCurrency AS 'Currency'                                                
   , Al.UserName as 'Booked By'                                                
   , pax.Titel + ' ' + pax.Name + ' ' + pax.Surname AS 'Passenger name'                                                
   , CONVERT(VARCHAR, B.TripStartDate, 101) + '-' + CONVERT(VARCHAR, B.TripEndDate, 101) AS 'Travel date'                                             
   ,'' AS 'AccountType'                                            
    ,case When AL.BookingCountry='IN' then 'Domestic' else 'International' End as 'TravelType'                                              
                                              
  ,case when B.BookingStatus='Confirmed' then 'Vouchered'else  B.BookingStatus end AS 'Booking Status'                                               
                                                 
   , B.providerConfirmationNumber AS 'Supplier confirmation'            
   , case when b.PaymentMode=1 then 'HOLD'            
   when b.PaymentMode=2 then 'Credit Limit'            
   when b.PaymentMode=3 then 'Make Payment'            
   when b.PaymentMode=4 then 'Self Balance'            
   end as 'Mode of Payment'            
   ,isnull(B.ModeOfCancellation,'') As ModeOfCancellation                                               
   , B.TripStartDate  as 'CheckInDate'                                              
   , B.TripEndDate  as 'CheckOutDate'                              
   ,'Credit Limit' as Booking_PaymentMode                              
   FROM TR.TR_BookingMaster B WITH(NOLOCK)            
    left join TR.TR_BookedCars TRC WITH(NOLOCK) on b.BookingId=TRC.BookingId            
   left join TR.TR_PaxDetails pax WITH(NOLOCK) on b.BookingId=pax.BookingId            
   left join tblAgentBalance TAB WITH(NOLOCK) on B.BookingRefId=TAB.BookingRef                                 
   LEFT JOIN B2BRegistration BR WITH(NOLOCK) ON B.AgentID = BR.FKUserID                                                
   LEFT JOIN Paymentmaster P WITH(NOLOCK) ON P.order_id = B.BookingRefId     
   LEFT JOIN AgentLogin AL WITH(NOLOCK) ON B.AgentID = AL.UserID                                                
   LEFT JOIN mCommon C WITH(NOLOCK) ON C.ID = AL.UserTypeID             
   WHERE B.AmountBeforePgCommission IS NOT NULL                          
--AND(B.PaymentMode = @PaymentTypeHotel or @PaymentTypeHotel='')            
AND @PaymentType!='' and B.PaymentMode = 2              
 AND @PaymentType not in(1,3)            
--AND B.AgentId IS NOT NULL    
AND (B.AgentId = @AgentId OR @AgentId = 0)AND B.BookingRefId IS NOT NULL                                               
AND ((@FROMDate IS NULL OR @ToDate IS NULL) OR (CAST(B.creationDate AS DATE) BETWEEN @FROMDate AND @ToDate))                                     
AND (AL.UserTypeID = @AgentTypeId OR @AgentTypeId = '')                         
--AND(@PaymentType = '')                                   
                                
  union                               
   ---HOLD------                           
   SELECT                                         CAST(B.BookingId AS VARCHAR(50)) AS BookMasterID                                                
   , BR.Icast as 'AgencyID'                                                
   , BR.AgencyName AS 'AgencyName'                                                  
   ,TAB.CreatedOn  AS 'DateTime'                                              
    ,(B.PickupLocation+'===>'+B.DropOffLocation) AS 'Description'                                                
  ...
  -- LEFT JOIN Paymentmaster P WITH(NOLOCK) ON P.order_id = B.BookingRefId                                            
   ...
   LEFT JOIN mCommon C WITH(NOLOCK) ON C.ID = AL.UserTypeID             
   WHERE B.AmountBeforePgCommission IS NOT NULL                          
AND @PaymentType!='' and B.PaymentMode = 1            
and @PaymentType not in(2,3)            
and b.PaymentMode is not null                       
--AND B.AgentId IS NOT NULL    
AND (B.AgentId = @AgentId OR @AgentId = 0)AND B.BookingRefId IS NOT NULL                                               
AND ((@FROMDate IS NULL OR @ToDate IS NULL) OR (CAST(B.creationDate AS DATE) BETWEEN @FROMDate AND @ToDate))                                     
...
--AND(@PaymentType = '')                     
  ...
  , TAB.CloseBalance AS 'Remaining'                                                
   ...
   , AL.bookingcountry AS 'Country'                   
   , b.BookingCurrency AS 'Currency'                                                
   , Al.UserName as 'Booked By'                                               , pax.Titel + ' ' + pax.Name + ' ' + pax.Surname AS 'Passenger name'                                                
   , CONVERT(VARCHAR, B.TripStartDate, 101) + '-' + CONVERT(VARCHAR, B.TripEndDate, 101) AS 'Travel date'                                             
   ,'' AS 'AccountType'                                            
    ,case When AL.BookingCountry='IN' then 'Domestic' else 'International' End as 'TravelType'                                              
  ...
  ,case when B.BookingStatus='Confirmed' then 'Vouchered'else  B.BookingStatus end AS 'Booking Status'                                               
   ...
   LEFT JOIN mCommon C WITH(NOLOCK) ON C.ID = AL.UserTypeID             
   WHERE B.AmountBeforePgCommission IS NOT NULL            
   AND @PaymentType!='' and B.PaymentMode = 3                  
   and @PaymentType not in(2,1)            
--AND B.PaymentMode = 3                  
and b.PaymentMode is not null                       
--AND B.AgentId IS NOT NULL    
AND (B.AgentId = @AgentId OR @AgentId = 0)AND B.BookingRefId IS NOT NULL                                               
...
AND ((@FROMDate IS NULL OR @ToDate IS NULL) OR (CAST(B.creationDate AS DATE) BETWEEN @FROMDate AND @ToDate))                                     
AND (AL.UserTypeID = @AgentTypeId OR @AgentTypeId = '')                                            
 ) Transfer order by Transfer.[DateTime]      
  
select * into #tempTableAASALL From(  
...
   AND  AB.TransactionType IN (CASE @PaymentType WHEN 'Credit' THEN AB.TransactionType WHEN '' THEN                                                   
   AB.TransactionType ELSE @PaymentType END)                                                    
     AND( BookingRef='Cash' OR BookingRef='Credit')                                                  
  AND ((@RiyaPNR = '')))  as AllAgentBal order by AllAgentBal.DateTime  
  
                            
 SELECT 'Air' AS Type,*   , '' AS 'TravelType'                                                  
  , '' AS 'Booking Status'                                                  
  , '' AS 'Supplier Confirmation'                                                 
  , '' AS 'Mode of Payment'                                                    
  --, 0 AS 'Pax count'                                                      
  ,'' as 'Mode Of cancellation'                                          
  , FORMAT(CAST(NULL AS DATETIME), 'dd-MMM-yyyy') CheckInDate                                                    
  , FORMAT(CAST(NULL AS DATETIME), 'dd-MMM-yyyy') CheckOutDate                                                 
   ,'' as Booking_PaymentMode                                           
...
SELECT 'Transfer' AS Type, *                                   
 ...
 FROM #tempTableAASTransfer                                              
 WHERE (@ProductType='ALL' OR @ProductType='Transfer')     
   
 UNION  
  SELECT case when @ProductType = 'Airline' then 'Air'  
  else  
  @ProductType end  AS Type,*   , '' AS 'TravelType'                                                  
  , '' AS 'Booking Status'                                                  
  , '' AS 'Supplier Confirmation'                                                 
  , '' AS 'Mode of Payment'                                                    
  --, 0 AS 'Pax count'                                                      
 ...
 FROM #tempTableAASALL                                                    
 WHERE (@ProductType='ALL' OR @ProductType in ('Airline','Hotel'))  
    
                          
 order by [DateTime]   
   
  
  select top 1 AgentBalance from agentLogin where UserID=@AgentId;
