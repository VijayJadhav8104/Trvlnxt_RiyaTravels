...
CREATE proc [dbo].[spInsertpaymentPostSSR]            
...
END            
 declare @MaskCardNumber varchar(50)=('XXXXXXXXXXXX'  + SUBSTRING(@card_number,len(@card_number)-3,len(@card_number)))            
