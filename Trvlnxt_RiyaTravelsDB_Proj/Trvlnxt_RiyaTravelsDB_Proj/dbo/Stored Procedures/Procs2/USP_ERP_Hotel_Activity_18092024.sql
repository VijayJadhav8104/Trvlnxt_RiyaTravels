...
CREATE PROCEDURE [dbo].[USP_ERP_Hotel_Activity_18092024]                     
...
WHERE HSHVouchred.FkStatusId = 4                    
 ...
 --AND BR.CustomerCode ='SACUST000004'                   
 ...
 -- )                    
and HBM.BookingReference in ('TNH00265024')                    
ORDER BY HBM.pkId DESC                    
 ...
 IF @Action = 'HotelCancellation'                        
  ...
  AND HBM.BookingReference='TNH00265024'  
  Order by HBM.pkId desc                    
   END                    
  ...
  left join B2BHotel_Commission B2BC on B2BC.Fk_BookId=HB.pkId                    
   ...
   and HB.BookingReference in ('TNH00264794')    --TNH00264660                
...
--USP_ERP_Hotel_Activity_18092024 'HotelBooking'