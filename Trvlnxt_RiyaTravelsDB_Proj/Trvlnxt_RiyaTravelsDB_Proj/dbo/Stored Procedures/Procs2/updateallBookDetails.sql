CREATE procedure [dbo].[updateallBookDetails]                                        
...
begin                                        
 ...
 set @CheckStatus= (Select FkStatusId from  Hotel_Status_History where FKHotelBookingId=@book_pk_id and IsActive=1)     


 if(@CurrentstatusID=@CheckStatus)
 begin
  return 1;
 end
  ...
  if(@QtechStatus='vouchered' and @CurrentStatus!='Confirmed')                                        
  begin                                        
 ...
 ,@MethodName  
   ...
   End         
     ...
     else if(@QtechStatus='vouchered' and @CurrentStatus='Confirmed')                                        
  begin                                        
     insert into Hotel_Status_History                                       
    (                                        
     FKHotelBookingId                                        
...
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[updateallBookDetails] TO [rt_read]
    AS [dbo];
