--sp_helptext USP_ERP_Hotel_Activity 'HotelBooking'                          
--=================================                          
...
CREATE PROCEDURE [dbo].[USP_ERP_Hotel_Activity_testBhushan]                                                                             
...
WHERE HSHVouchred.FkStatusId = 4                                                                            
 ...
 AND Cast(HBM.creationDate as date) >=cast('2025-02-19' as date)        
...
LEFT JOIN agentLogin AL ON AL.UserID = HBM.AgentID                                                                         
 ...
 AND Cast(HBM.creationDate as date) >=cast('2025-02-20' as date)        
 and BR.country in ('India','UAE','CA','US')      
  ...
  --and HBM.BookingRefId in ('TNA0001555')                                                                                
