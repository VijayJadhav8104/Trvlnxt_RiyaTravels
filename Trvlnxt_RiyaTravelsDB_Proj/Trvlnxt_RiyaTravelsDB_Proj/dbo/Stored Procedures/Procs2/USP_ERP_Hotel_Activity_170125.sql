--sp_helptext [USP_ERP_Hotel_Activity_170125] 'HotelBooking'                  
--=================================                  
...
CREATE PROCEDURE [dbo].[USP_ERP_Hotel_Activity_170125]                                                                     
...
and HBM.BookingReference in ('TNHAPI00083474','TNHAPI00084669','TNHAPI00085198','TNHAPI00085263','TNHAPI00085301')   --,'TNHAPI00083474'
ORDER BY HBM.pkId DESC                                                                    
 ...
 WHEN HBM.BookingCountry = 'SA' THEN 'VEND00024'   
  ...
  MU.EmployeeNo 'EmployeeCode',                                                                    
   ...
   DisplayDiscountRate 'BaseAmount',0 'TaxAmount',MarkupAmount 'MarkupOnBaseFare',                                                                    
