CREATE PROCEDURE [dbo].[sp_GetTicketCount2]
...
where Country='IN'and AgentID='B2C' and  tbm.totalFare>0 and tpbd.totalFare>0 AND IsBooked=1 and convert(varchar(12),tbm.inserteddate,102) = convert(varchar(12),Getdate(),102)
...
inner join tblPassengerBookDetails tpbd on tbm.pkid=tpbd.fkBookMaster-- and tpbd.isReturn=0
where Country='US'and AgentID='B2C' AND IsBooked=1 and  tbm.totalFare>0 and tpbd.totalFare>0 and convert(varchar(12),tbm.inserteddate,102) = convert(varchar(12),Getdate(),102)
Group by AgentID,Country
...
cast(cast(round(sum(tpbd.totalFare),0) as int) as varchar(50) ) + ' INR' as [Total sale]  from tblBookMaster tbm
inner join tblPassengerBookDetails tpbd on tbm.pkid=tpbd.fkBookMaster --and tpbd.isReturn=0
where Country='CA'and AgentID='B2C' AND IsBooked=1 and  tbm.totalFare>0 and tpbd.totalFare>0 and convert(varchar(12),tbm.inserteddate,102) = convert(varchar(12),Getdate(),102)
Group by AgentID,Country
...
convert(varchar(12),tbm.inserteddate,102) = convert(varchar(12),Getdate(),102)
...
AND IsBooked=1 and convert(varchar(12),tbm.inserteddate,102) = convert(varchar(12),Getdate(),102)
Group by TBM.Country
...
where TBM.Country='IN'and AL.userTypeID=2 AND IsBooked=1 and  tbm.totalFare>0 and tpbd.totalFare>0 and convert(varchar(12),tbm.inserteddate,102) = convert(varchar(12),Getdate(),102)
Group by TBM.Country
...
inner join tblPassengerBookDetails tpbd on tbm.pkid=tpbd.fkBookMaster
inner join agentLogin AL ON AL.UserID=tbm.AgentID  AND tbm.AgentID!='B2C'
where TBM.Country='IN'and AL.userTypeID=4 AND IsBooked=1 and  tbm.totalFare>0 and tpbd.totalFare>0 and convert(varchar(12),tbm.inserteddate,102) = convert(varchar(12),Getdate(),102)
Group by TBM.Country
...
inner join tblPassengerBookDetails tpbd on tbm.pkid=tpbd.fkBookMaster
inner join agentLogin AL ON AL.UserID=tbm.AgentID AND tbm.AgentID!='B2C'
where TBM.Country='IN'and AL.userTypeID=3 AND IsBooked=1 and  tbm.totalFare>0 and tpbd.totalFare>0 and convert(varchar(12),tbm.inserteddate,102) = convert(varchar(12),Getdate(),102)
Group by TBM.Country
...
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[sp_GetTicketCount2] TO [rt_read]
    AS [dbo];
