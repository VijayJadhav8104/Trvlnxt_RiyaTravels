--sp_helptext [USP_ERP_Hotel_Activity_27122024] 'HotelBooking'                  
--sp_helptext [USP_ERP_Hotel_Activity_27122024] 'HotelCancellation'                  
--=================================                  
...
CREATE PROCEDURE [dbo].[USP_ERP_Hotel_Activity_27122024]                                                                     
...
-- ,4                                                                    
 ...
 -- )                                                                    
and HBM.BookingReference in ('TNH00272425','TNH00272426')                                                                    
ORDER BY HBM.pkId DESC                                                                    
 ...
 IF @Action = 'HotelCancellation'                                                                        
  ...
  ,HBM.TotalAdults as 'NOOfAdults'                                                                    
  ,HBM.TotalChildren as 'NOOfChildren'                                                       
  ,'' 'NOOfInfant'                                                                      ,HBM.RatePerNight 'RatePerNight-No'                                                                    
  ,'' 'ChildRate'                                                                    
  ,'' 'ExtraBed'                                   
  from Hotel_BookMaster HBM                                
  left join B2BRegistration BR on HBM.RiyaAgentID=BR.FKUserID                                                                    
...
---Test entry comment on live
and HBM.BookingReference in ('TNH00272426','TNH00272425')                
 ...
 CASE                                       
    ...
    ELSE 'VEND00189'  -- Default for the first condition                                      
...
WHERE HSHVouchred.FkStatusId = 4                                                                    
 ...
 --WHEN HBM.providerId in ('rt-vtactivities-live','rt-hbactivities-live') then 'CA'                                                                   --end                                                                    
 --and HBM.BookingRefId in ('TNA0001291','TNA0001292')                                                                    
