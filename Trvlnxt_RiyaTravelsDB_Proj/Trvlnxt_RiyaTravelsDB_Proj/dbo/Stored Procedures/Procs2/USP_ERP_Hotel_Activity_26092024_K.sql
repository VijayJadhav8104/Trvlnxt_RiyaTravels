...
CREATE PROCEDURE [dbo].[USP_ERP_Hotel_Activity_26092024_K]                 
...
WHERE HSHVouchred.FkStatusId = 4                
 ...
 -- )                
and HBM.BookingReference in ('TNH00265670')                
...
,CASE   WHEN BR.Country = 'AE' OR BR.Country = 'UAE' OR HBM.providerId = 'rt-rtactivities-live'      THEN 'CC1012000'   WHEN BR.Country = 'SAUDI ARABIA'      THEN 'CC1013000'   ELSE 'CC1001000' END AS DivisionCode                  
 ,MU.EmployeeNo 'EmployeeCode'                
 ,'INR' AS 'SalesCurrencyCode'                
 ,'INR' AS 'PurchCurrencyCode'                
