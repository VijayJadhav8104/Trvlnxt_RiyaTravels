...
CREATE PROCEDURE [dbo].[USP_ERP_Hotel_Activity_141024]                             
...
ORDER BY HBM.pkId DESC                            
 ...
 CASE 
    WHEN HBM.providerId = 'rt-hbactivities-live' AND BR.country = 'UAE' THEN 'VEND000024'
    ...
    --WHEN HBM.providerId = 'rt-rtactivities-live' AND BR.country = 'UNITED KINGDOM' THEN ''  -- Adjust as necessary
    ELSE 'CVEND00242' 
END AS PayToVendor
