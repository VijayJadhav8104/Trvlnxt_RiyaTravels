CREATE PROCEDURE [dbo].[UpdateStaffCheckBalance]         
  @UserId INT =null                 
...
BEGIN        
 ...
 BEGIN              
   ...
   insert into tblSelfBalance(userid,BookingRef,OpenBalance,TranscationAmount,CloseBalance,CreatedBy,TransactionType,ProductType)            
   values(@UserId,@OrderId,@Amt,@Balance,@Balance+@Amt,@CreatedBy,@TransactionType,@producttype)            
...
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[UpdateStaffCheckBalance] TO [rt_read]
    AS [dbo];
