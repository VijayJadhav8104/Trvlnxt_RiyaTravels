...
CREATE PROCEDURE [dbo].[USP_ERP_Hotel_Activity_221024]                                   
...
IF @Action = 'SightSeeingBooking'                                      
 ...
 ,case when HBM.providerId = 'rt-rtactivities-live' and Al.userTypeID!= 4 then 'UAE' else BR.country end as 'country'
  ,case when HBM.providerId = 'rt-hbactivities-live,rt-vtactivities-live' and Al.userTypeID!=4 then 'INDIA' else BR.country end as 'country'
 ,HBM.BookingStatus                                  
 ,BR.CustomerCOde                                  
