CREATE proc [dbo].[Sp_GetDealMappingTest] --FetchFlightCommission '28/02/2022 00:00:00 AM','28/02/2022 00:00:00 AM','US','I','ALL','B2B','40028','','','','NYC','BOM','','Y'
 @Travelfrom datetime,
 @Travelto datetime,
...
begin
   ...
   DECLARE @ParentAgentID VARCHAR (MAX);

  SELECT @ParentAgentID = ParentAgentID  FROM agentLogin WHERE UserID = @AgencyNames  
...
AgentLogin,Password,IATA,agentidentifier
...
AND ((UserType=@UserType AND ( (agencyid like   '%' +  @ParentAgentID +'%' ) OR AgencyId='0') ))
