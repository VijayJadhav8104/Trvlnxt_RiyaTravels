...
--exec [B2BHotel_SearchBookings] @BookingID='TNHAPI00047601'  ,@ExcelFlag='Excel'                                                      
--exec [B2BHotel_SearchBookings] @BookingFromDate='01/01/2025',@BookingToDate='02/01/2025' ,@ExcelFlag='Excel'                                                 
 --   exec   [B2BHotel_SearchBookings_new] 
	--@ExcelFlag='Gride'                                                                                                                                  
                                                                                                                                                                                                                                     
CREATE PROCEDURE [dbo].[B2BHotel_SearchBookings_new]         
...
set @BookingToDate=GETDATE()                                             
 ...
 begin                                                                                 
  select top 400                                                 
   ...
   ,  HB.orderId as 'OrderID' ,Case When HM.Status = 'Confirmed' Then '<span style="color:blue; ">Hold</span>'+' / '+   Case when B2BPaymentMode=1 then '<span style="color:blue; ">Hold</span>'                                                                                                                                                                                           
