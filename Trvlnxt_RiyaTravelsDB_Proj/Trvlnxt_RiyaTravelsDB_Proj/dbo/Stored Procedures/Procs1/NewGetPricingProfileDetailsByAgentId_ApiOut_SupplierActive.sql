...
-- NewGetPricingProfileDetailsByAgentId_ApiOut 46999 ,'IN','US'              
-- Created By Ketan                                                             
-- Created Date : 06-02-2025                                                      
--=============================================================                                                  
CREATE PROC NewGetPricingProfileDetailsByAgentId_ApiOut_SupplierActive                                                             
@AgentId INT  ,                                           
...
BEGIN                                                                      
 ...
 BEGIN            
  ...
  --PRINT @SupplierCurrency        
    ...
    AND PM.IsActive=1 AND sm.RhSupplierId IS NOT NULL AND sm.SupplierType='Hotel'                             
