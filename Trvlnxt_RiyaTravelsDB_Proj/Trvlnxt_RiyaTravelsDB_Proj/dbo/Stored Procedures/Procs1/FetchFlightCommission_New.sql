...
CREATE proc [dbo].[FetchFlightCommission_New] --FetchFlightCommission '5/10/2020 12:45:00 AM','5/10/2020 12:45:00 AM','US','D','UA','B2B','6','','','','JFK','AMS','','K - Standard Economy'
 @Travelfrom datetime,
 @Travelto datetime,
...
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[FetchFlightCommission_New] TO [rt_read]
    AS [dbo];
