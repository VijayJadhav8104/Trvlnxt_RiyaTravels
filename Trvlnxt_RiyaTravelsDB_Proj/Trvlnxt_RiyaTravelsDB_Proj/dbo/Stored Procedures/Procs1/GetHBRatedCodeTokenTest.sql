...
CREATE Proc GetHBRatedCodeTokenTest        
...
BEgin        
 ...
 if exists (select * from [Hotel].ApiBookData where BookingId=@BookingId)      
 begin      
     select @IsBId='Yes'      
 End      
 else      
 Begin      
      select @IsBId='No'      
 End      
  if exists (select * from [Hotel].ApiBookData where ClientBookingID=@ClientBookingId)      
 begin      
     select @IsCBId='Yes'      
 End      
 else      
