CREATE PROC [dbo].[GetList_ClientDetails_New1]
@Status int ,
@FromDate Date=null, 
@ToDate Date=null,
@AgentId int=null,
...
IF OBJECT_ID ( 'tempdb..#tempTableA') IS NOT NULL
	...
	(CASE 
				...
				where  Status =	(CASE @Status WHEN 4 then 
Status else @Status end) AND FKUserID IS NOT NULL 
...
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[GetList_ClientDetails_New1] TO [rt_read]
    AS [dbo];
