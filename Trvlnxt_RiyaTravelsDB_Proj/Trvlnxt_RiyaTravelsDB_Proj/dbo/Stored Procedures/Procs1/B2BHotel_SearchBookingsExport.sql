...
--exec [B2BHotel_SearchBookings] @BookingID='TNHAPI00015872'         
--,@ExcelFlag='Excel'                                                              
--exec [B2BHotel_SearchBookings] @BookingFromDate='11/02/2025',@BookingToDate='11/02/2025'  
--,@ExcelFlag='Excel'                                                         
                                                                                                                                               
                                                                                                                                                                                                                                             
CREATE PROCEDURE [dbo].[B2BHotel_SearchBookingsExport]                 
...
set @BookingFromDate='01/06/2023'                                                                                                                                                                                                        
set @BookingToDate=GETDATE()                                                     
 ...
 begin                                                          
  ...
  select distinct  top 400                                                         
   ...
   ,  HB.orderId as 'OrderID' ,Case When HM.Status = 'Confirmed' Then '<span style="color:blue; ">Hold</span>'+' / '+   Case                                                                                                                                  
