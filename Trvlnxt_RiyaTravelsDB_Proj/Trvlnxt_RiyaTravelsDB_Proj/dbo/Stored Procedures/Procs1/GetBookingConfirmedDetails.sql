...
--GetBookingConfirmedDetails'TNH00000383','',51354      
CREATE PROCEDURE GetBookingConfirmedDetails                                                                                  
...
------> Confirmation details                                                                                    
 ...
 HB.CurrencyCode as 'Currency',                                                                                    
  ...
  --inner join muser MU on HB.MainAgentID=MU.ID                             
   where                           
  (HB.pkId = @pkid or @pkid=null or HB.BookingReference=@bookingid or @bookingid=null) and SH.IsActive=1 and RiyaAgentID=@AgentId                                                                                              
-- passenger details                                              
  ...
  where (HB.pkId = @pkid or @pkid=null or HB.BookingReference=@bookingid or @bookingid=null) and RiyaAgentID=@AgentId                                              
