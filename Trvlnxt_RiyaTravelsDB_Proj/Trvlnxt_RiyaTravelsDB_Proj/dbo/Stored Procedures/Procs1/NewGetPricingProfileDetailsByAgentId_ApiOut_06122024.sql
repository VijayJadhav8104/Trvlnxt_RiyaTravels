...
-- NewGetPricingProfileDetailsByAgentId_ApiOut_06122024 46999 ,'IN'                                                   
-- Created By Ketan                                             
-- Created Date : 27-12-2023                                      
--=============================================================                                  
CREATE PROC NewGetPricingProfileDetailsByAgentId_ApiOut_06122024                                             
@AgentId INT  ,                           
...
BEGIN                                                      
 ...
 SELECT PM.AgentId,PM.SupplierId,PM.ProfileId,PM.CancellationHours,ISNULL(HCM.Value,'') as SupplierCurrency                                                  
...
,SM.Is_Req_Domestic_Pan,SM.Is_Req_International_Pan,SM.PayAtHotel,SM.IsHotelContentAvail            
 ...
 left join mCommon HCM on  HCM.ID=SM.SupplierCurrency and HCM.Category='Currency'
