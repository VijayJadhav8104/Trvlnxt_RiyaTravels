--GetBookingConfirmedDetailsNew_Tet'TNH00273665','',21958                                                                                      
CREATE PROCEDURE GetBookingConfirmedDetailsNew_Tet                                                                                                                                                                 
...
--- Room Details                                                                                                                             
  select ISNULL(Room.RoomMealBasis,'') as RoomMealBasis,ISNULL(Room.RoomDiscription,'') as RoomDiscription,  Room.* from Hotel_Room_master as Room                                                                                                             
