--fetchERPData_NEW2_JN '2022-12-27','2022-12-27',1,2,'ae','2','45582'
CREATE procedure [dbo].[fetchERPData_NEW2_JN] --fetchERPData_NEW2 '18-dec-2022','18-dec-2022',1,2,'ae','2',''
...
--group by p.pid) as [Meal Charges]
 (dbo.Get_SSR_Amount_By_SSR_Type (book.riyaPNR,'Meals')) as [Meal Charges]
