CREATE PROCEDURE [dbo].[GetPNRRetrivalFromAudit]                           
@type varchar(20) = ''                  
...
and ISNULL((select top 1 isnull(country,'') from B2BRegistration where Icast = ICust),'') != 'UAE' and (( ICust != 'BOMCUST000123') or  ICust is null)
      
end
GO
GRANT VIEW DEFINITION
    ON OBJECT::[dbo].[GetPNRRetrivalFromAudit] TO [rt_read]
    AS [dbo];
