...
--Proc_ExportManageBookingData_v2 46999,0,'2023-09-07','2023-09-07'                   
CREATE Procedure [dbo].[Proc_ExportManageBookingData_v2]        
@AgentId int = 0 ,                     
@MainAgentId int = 0,                  
...
set @ToDate = DATEADD(DAY,1,@FromDate)                                                                          
 ...
 Select               
   ...
   0 as AccountCredit,  
   isnull(BC.Commission,0) as CommCredit,        
   0 as CommDebit,        
 ...
 Select               
   ...
   0 as AccountCredit,  
   0 as CommCredit,        
   isnull(BC.Commission,0) as CommDebit,        
   case when tbs.CloseBalance is null then tbla.CloseBalance end as ClosingBalance         
   from Hotel_BookMaster HB                                                                                      
