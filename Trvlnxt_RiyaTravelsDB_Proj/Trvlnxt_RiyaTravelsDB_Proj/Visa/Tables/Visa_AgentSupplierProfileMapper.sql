CREATE TABLE [Visa].[Visa_AgentSupplierProfileMapper] (
    ...
    [IsActive]                  BIT             CONSTRAINT [DF_Visa_AgentSupplierProfileMapper_IsActive] DEFAULT ((0)) NULL,
    ...
    [RateCodeid]                INT             NULL,
    [IsRateCodeRequired]        BIT             CONSTRAINT [DF_Visa_AgentSupplierProfileMapper_IsRateCodeRequired] DEFAULT ((0)) NULL,
    [IsPccRequired]             BIT             CONSTRAINT [DF_Visa_AgentSupplierProfileMapper_IsPccRequired] DEFAULT ((0)) NULL,
